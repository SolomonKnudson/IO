...
namespace Operator
{
  template <> struct Impl<io::internal::impl::iostream>
  {
  ...
  template <> struct Impl<io::internal::impl::cin>
  {
  ...
  template <> struct Impl<io::internal::impl::wcin>
  {
    template <typename LValue>
    static decltype(auto)
    invoke(LValue&& l_value)
  ...
  template <> struct Impl<io::internal::impl::cout>
  {
  ...
  template <> struct Impl<io::internal::impl::wcout>
  {
    template <typename... Args>
    static decltype(auto)
    invoke(Args&&... args)
  ...
  template <> struct Impl<io::internal::impl::cerr>
  {
    template <typename... Args>
    static decltype(auto)
    invoke(Args&&... args)
  ...
  template <> struct Impl<io::internal::impl::wcerr>
  {
    template <typename... Args>
    static decltype(auto)
    invoke(Args&&... args)
  ...
  template <> struct Impl<io::internal::impl::clog>
  {
    template <typename... Args>
    static decltype(auto)
    invoke(Args&&... args)
  ...
  template <> struct Impl<io::internal::impl::wclog>
  {
    template <typename... Args>
    static decltype(auto)
    invoke(Args&&... args)
